...
class AuthController extends Controller
{
     ...
     * @bodyParam fcm_token string optional Jeton FCM. Example: "eQ8XsH7VQ9KnZCwJ6b4Ayz:APA91bG5LjK7"
     ...
     * @bodyParam permission_status string optional Statut des permissions de notifications. Example: "authorized"
     *
     * @response 201 {
     ...
     * @bodyParam first_name string optional (non utilisé ici, pour homogénéité du payload). Example: "John"
     * @bodyParam last_name string optional Example: "Doe"
     * @bodyParam phone string optional Example: "+33123456789"
     * @bodyParam city string optional Example: "Paris"
     * @bodyParam address string optional Example: "123 Rue Lafayette"
     * @bodyParam birthday date optional Example: "1998-05-03"
     * @bodyParam company_name string optional Example: "Acme Corp"
     * @bodyParam fcm_token string optional Example: "eQ8XsH7VQ9KnZCwJ6b4Ayz:APA91bG5LjK7"
     * @bodyParam device_id string optional Example: "123e4567-e89b-12d3-a456-426614174000"
     * @bodyParam platform string optional Example: "ios"
     * @bodyParam app_version string optional Example: "1.2.3"
     * @bodyParam os_version string optional Example: "iOS 15.0"
     * @bodyParam device_model string optional Example: "iPhone 13"
     * @bodyParam permission_status string optional Example: "authorized"
     *
     * @response 200 {
     *   "token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9...",
    ...
    public function login(Request $request): JsonResponse
    {
        $credentials = $request->validate([
            ...
            // Champs supplémentaires acceptés mais non obligatoires.
            'first_name' => ['nullable', 'string', 'max:255'],
            'last_name' => ['nullable', 'string', 'max:255'],
            'phone' => ['nullable', 'string', 'max:50'],
            'city' => ['nullable', 'string', 'max:100'],
